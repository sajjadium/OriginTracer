...
public:
	...
	set<pair<string, const void *> > m_eventListeners;
	string m_type;
	KURL m_url;
	unordered_set<string> labels;

	InclusionNode(int m_id, const void *, const void *, const void *, const string &, const KURL &);
};
...
public:
	...
	map<tuple<const void *, const string, const void *>, const void *> m_eventListenerScriptMapping;

	vector<InclusionNode *> m_executingScripts;
	set<InclusionNode *> m_executingAsyncDeferScripts;
	...
	void highlightInjectedElement(const void *);
	void preload(const string &);
	void add(const void *, const void *, const string &, const KURL &);
	void add(const void *, const void *, const string &);
